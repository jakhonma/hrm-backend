...
SECRET_KEY = 'django-insecure-!p+6m@af&(faf99ybt$#fws=3llmz@6)m8qfixb--lm^sylhi0'
...
AUTHENTICATION_BACKENDS = [
    "apps.users.backends.UsernameOrPhoneBackend",  # custom backend
    "django.contrib.auth.backends.ModelBackend",  # default backend (fallback uchun)
]
